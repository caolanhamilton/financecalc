const loanMap = {
  ...
  "Interest Bearing 14.9% over 24 months": { apr: 14.9, length: 24 },
  "Interest Bearing 14.9% over 36 months": { apr: 14.9, length: 36 },
  "Interest Bearing 14.9% over 48 months": { apr: 14.9, length: 48 },
